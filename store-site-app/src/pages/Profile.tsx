...
export default function Profile() {
  ...
  const {
    ...
    queryFn: async () => await getRestaurantsByUser(user._id),
  });
  ...
  const {
    ...
    queryKey: ["review"],
    queryFn: async () => await getReviewsByUser(user._id),
  });
      ...
      >
        ...
        {restaurantLoading ? (
          ...
          <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
            {!restaurants.length && (
              <Typography>You haven't created any restaurants!</Typography>
            )}
        ...
        {reviewLoading ? (
          ...
          <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
            {!reviews.length && (
              <Typography>You haven't created any reviews!</Typography>
            )}
