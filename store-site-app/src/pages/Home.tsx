        ...
        <>
            ...
            <Container maxWidth="lg" sx={{marginTop: "100px"}}>
                ...
                >
                    ...
                    <Button variant="contained" color="primary" size="large" sx={{ mb: 6 }} onClick={() => {navigate("/restaurants")}}>
                        Find a Restaurant
                    </Button>
                    <Box
                        component="img"
                        ...
                        sx={{ width: "100%", maxWidth: "600px", borderRadius: "8px", boxShadow: 3 }}
                    />
                </Box>
                ...
                <Box sx={{ py: 8, textAlign: "center" }}>
                    ...
                    <Typography color="text.secondary" sx={{ mb: 4 }}>
                        Learn more about our mission to connect food lovers with the best dining experiences.
                    </Typography>
                    <Box
                        component="img"
