...
export class ReviewsService {
  ...
  async updateReview(reviewId: ObjectId | string, updateReviewData: UpdateReviewDTO, user: any) {
  ...
  async deleteReview(reviewId: ObjectId, restaurantId: ObjectId, user: any) {
    ...
    const updatedReviews = restaurantReviews.filter(review => !review.equals(reviewId))

    return this.restaurantsService.updateRestaurantReviews(restaurantId, updatedReviews)
  }
